...
export default function AetherHero({
  ...
  // `clearColor` arrivait sous forme de tableau litteral par defaut : une
  // nouvelle identite a chaque rendu, donc l'effet se relançait en boucle
  // et le contexte WebGL etait recree sans arret. On le fige.
  const clear = React.useMemo<[number, number, number, number]>(
    () => clearColor ?? [0, 0, 0, 1],
    [clearColor]
  );
